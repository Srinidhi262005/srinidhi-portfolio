/**
 * Projects — https://github.com/Srinidhi262005
 *
 * Screenshots (optional): save to public/projects/ then set `image` below.
 * Example: public/projects/resume-analyzer.png → image: '/projects/resume-analyzer.png'
 * Missing images fall back to gradient + emoji automatically.
 */
export const projects = [
  ...
  },
  {
    ...
    icon: '🌾',
    image: '/projects/farmse.png',
    year: '2024',
  },
  {
    id: 'electricity-predictor',
    title: 'Smart Electricity Bill Predictor & Analyzer',
    description:
      'React + Flask system for bill prediction, anomaly detection, Tesseract OCR meter reading, and a bilingual (English & Telugu) chatbot with energy-saving insights.',
    tech: ['React', 'Vite', 'Flask', 'OCR', 'Tailwind'],
    github: 'https://github.com/Srinidhi262005/-smart-electricity-bill-analyzer',
    demo: 'https://smart-electricity-bill-analyzer.vercel.app',
    gradient: 'from-blue-500/20 to-indigo-600/20',
    icon: '⚡',
    image: '/projects/electricity-live.png',
    year: '2024',
  },
];
